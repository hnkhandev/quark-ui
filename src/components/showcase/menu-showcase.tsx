      ...
      <ComponentShowcaseCard>
        <div className="flex flex-col gap-1">
          <Ariakit.MenuProvider>
            ...
            >
              <Ariakit.MenuItem className="py-2 px-2 flex items-center hover:bg-blue-500 hover:text-white rounded aria-disabled:text-disabled">
                Account
              </Ariakit.MenuItem>
              <Ariakit.MenuItem className="py-2 px-2 flex items-center hover:bg-blue-500 hover:text-white rounded aria-disabled:text-disabled">
                Settings
              ...
              <Ariakit.MenuItem
                className="py-2 px-2 flex items-center hover:bg-blue-500 hover:text-white rounded aria-disabled:text-disabled"
                disabled
              >
                Pricing
              </Ariakit.MenuItem>
